...
rast_rodmanetal2019_fn <- function(
  ...
  names(composite) <- c("panchromatic", "local_sd", "local_minima")
...
```{r}
rodmanetal2019_rast <- rast_rodmanetal2019_fn(
...
# plot
terra::plot(
  rodmanetal2019_rast$local_minima
...
there should be at most 10 clusters
  ...
  # scale the buffer based on the largest
    ...
    class_temp <- ggplot2::ggplot() +
      ...
      ggplot2::scale_fill_manual(
        values = c(
          "1" = viridis::turbo(n=10)[1]
          , "2" = viridis::turbo(n=10)[2]
          , "3" = viridis::turbo(n=10)[3]
          , "4" = viridis::turbo(n=10)[4]
          , "5" = viridis::turbo(n=10)[5]
          , "6" = viridis::turbo(n=10)[6]
...
ggplot2::ggsave("../data/pile_tiles_kmeans.jpeg", height = 10.5, width = 8)
```
